...
// configuration step. It creates a namespace called `MyGLViewer`. You can modify
...
{
  try {
    CLI::App app{ fmt::format("{} version {}", MyGLViewer::cmake::project_name, MyGLViewer::cmake::project_version) };
    ...
    if (show_version) {
      fmt::print("{}\n", MyGLViewer::cmake::project_version);
      return EXIT_SUCCESS;
    }
